...
The project focuses on both attack methodology and secure coding practices, emphasizing the importance of defense-in-depth rather than relying on a single security control.
...
Methodology
Each workshop follows the same workflow:
    1. Identify the vulnerability.
    2. Exploit the weakness in a controlled environment.
    3. Analyze why the attack succeeds.
    4. Implement defensive measures.
    5. Verify that the vulnerability has been mitigated.
    6. Assess the remaining risk using OWASP Risk Rating principles.
